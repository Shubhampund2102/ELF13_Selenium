...
public class ExcelUtil {
	public double getDoubleNumericCellValue(String path,String sheetName,int row,int cell) throws Exception {
	...
	public int getIntegerNumericCellValue1(String path,String sheetName,int row,int cell) throws Exception {
		File file=new File(path);
		FileInputStream fis=new FileInputStream(file);
		Workbook workbook=WorkbookFactory.create(fis);
	...
	public String[][] getMultipleTypeOfData(String path,String sheetName) throws Exception {
		File file=new File(path);
		FileInputStream fis=new FileInputStream(file);
		Workbook workbook=WorkbookFactory.create(fis);
		...
		for (int i = 0; i < rowCount; i++) {				//row=4    cell=1
